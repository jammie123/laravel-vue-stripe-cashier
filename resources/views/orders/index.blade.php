    ...
    <div class="py-12 container mx-auto">
        ...
        <table class="table-auto">
            ...
            @foreach($orders as $order)
                <tr>
                    <td class="w-1/4 border border-gray-900 px-4 py-2 text-light-blue-600 font-medium"><a href="{{route('orders.show' ,$order->id)}}" class="text-blue-800 underline">{{ $order->transaction_id }}</a></td>
